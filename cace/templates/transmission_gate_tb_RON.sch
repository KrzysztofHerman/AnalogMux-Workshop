...
N 620 -100 620 -90 {
lab=Vdd}
C {devices/code_shown.sym} -320 -660 0 0 {name=MODEL only_toplevel=true
...
C {/workspaces/usm-vlsi-tools/shared_xserver/AnalogMux-Workshop/design_data/xschem/tgate/transmission_gate.sym} -50 40 0 0 {name=x1}
C {/workspaces/usm-vlsi-tools/shared_xserver/AnalogMux-Workshop/design_data/xschem/tgate/transmission_gate.sym} 620 40 0 0 {name=x2}
